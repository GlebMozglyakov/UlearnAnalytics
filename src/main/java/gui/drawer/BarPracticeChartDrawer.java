...
public class BarPracticeChartDrawer extends JFrame {
    public BarPracticeChartDrawer(List<StudentPerformance> studentPerformances) {
    ...
    public static JPanel createPracticeEachSection(List<StudentPerformance> studentPerformances) {
        JFreeChart chart = createBarChart(ChartDataMapper.createAllPracticeScoreInEachSection(studentPerformances));
    ...
    private static JFreeChart createBarChart(CategoryDataset dataset) {
        JFreeChart chart = ChartFactory.createBarChart(
                convertCP1251toUTF8("Средний балл ученика за практики в каждом разделе"),
